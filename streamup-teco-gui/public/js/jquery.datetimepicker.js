		...
		createDateTimePicker = function (input) {
			...
			datetimepicker.setOptions = function (_options) {
				...
				if (options.inline) {
					...
					if (options.inputVisibleWhenInline) {
						// optional TODO: add clear button
						// create new parent						
						// add input to it
						// create new button
						// add button to it
						// add js to clear input
						input.width(input.next('.xdsoft_inline').width());
