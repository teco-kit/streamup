...
<html lang="en">
<head>
    <title>Code coverage report for levelgraph-n3/index.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">levelgraph-n3/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">levelgraph-n3/</a> &#187; index.js</div>
</div>
<div class="body">
...
function levelgraphN3(db) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (db.n3) {
...
&nbsp;
  graphdb.searchStream = function(conditions, options) {
    var stream;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options &amp;&amp; options.n3) {
...
&nbsp;
  graphdb.search = function(conditions, options, callback) {
    var stream;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options.n3) {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return db.search(conditions, options, callback);</span>
  };
&nbsp;
  return graphdb;
}
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Nov 17 2014 23:38:11 GMT+0100 (CET)</div>
</div>
